...
public class Application {
    ...
    @Bean
    public CommandLineRunner demo(final HomeElectricalDevicesRepository repository) {
        return (args) -> {
            ...
            repository.save(new ElectricalKettle("Tefal", false, 5.0, 2.0, 1.0, Purpose.HEATING,
